...
pasta = 'D:/IP_DATA/IP_DATA/dadosBrutos/'
...
def baixa(i,processo):
    ...
    try:
        ...
        if (processo in arqs):
            ...
            urlretrieve( urlBase % processo, 'C:/IP_DATA/dadosBrutos/%s' % processo);
...
df = pd.read_csv("D:/IP_DATA/IP_DATA/mpf_cod_2015.csv", index_col=0,names=['numproc'], skiprows=1)
